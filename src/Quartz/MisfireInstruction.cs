...
public struct MisfireInstruction
{
    ...
    /// <summary>
    /// Misfire instructions for CustomCalendarTrigger
    /// </summary>
    public struct CustomCalendarTrigger
    {
        /// <summary>
        /// Instructs the <see cref="IScheduler" /> that upon a mis-fire
        /// situation, the <see cref="ICustomCalendarTrigger" /> wants to be
        /// fired now by <see cref="IScheduler" />.
        /// </summary>
        public const int FireOnceNow = 1;
        ...
        /// <summary>
        /// Instructs the <see cref="IScheduler" /> that upon a mis-fire
        /// situation, the <see cref="CustomCalendarTrigger" /> wants to have it's
        /// next-fire-time updated to the next time in the schedule after the
        /// current time (taking into account any associated <see cref="ICalendar" />),
        /// but it does not want to be fired now.
        /// </summary>
